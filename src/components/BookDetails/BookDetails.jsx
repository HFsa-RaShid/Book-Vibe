    ...
    return (
        <div className="lg:flex h-[500px] gap-8 mt-10 px-20">
            ...
            <div className="w-full lg:w-[50%] text-left">
                <h1 className="text-[40px] font-bold text-left fonts">{book.bookName}</h1>
                <p className="text-[#131313CC] text-[20px] pb-2 font ">By: {book.author}</p>
                <hr></hr>
                <p className="text-[#131313CC] text-[20px] text-left py-3 font">{book.category}</p>
                <hr></hr>
                <p className="text-[#131313CC] text-[16px] pt-2 pb-8 font"><span className="text-black font-bold">Review: </span>{book.review}</p>
                <div className="flex gap-8">
                    <p className="text-black font-bold font">Tag</p>
                ...
                <div className="flex font">
                    <p className="w-[50%] lg:w-[30%] ">Number of Pages:</p>
                    <p className="font-bold text-[#131313CC] ">{book.totalPages}</p>
                </div>
                <div className="flex my-3 font">
                    <p className="w-[50%] lg:w-[30%] ">Publisher:</p>
                    <p className="font-bold text-[#131313CC] ">{book.publisher}</p>
                </div>
                <div className="flex font">
                    <p className=" w-[50%] lg:w-[30%] ">Year of Publishing:</p>
                    <p className="font-bold text-[#131313CC] ">{book.yearOfPublishing}</p>
                </div>
                <div className="flex my-3 font">
                    <p className="w-[50%] lg:w-[30%]">Rating:</p>
                    <p className="font-bold text-[#131313CC]">{book.rating}</p>
                </div>

                <div className="flex gap-8 mt-5 font">
